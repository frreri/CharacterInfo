...
def SQLinsert(search_result, source):
    ...
    val = (search_result[16], search_result[1], search_result[2], search_result[3], search_result[4], search_result[5],
        search_result[6], search_result[7],search_result[8], search_result[0], datetime.datetime.now(), source)
