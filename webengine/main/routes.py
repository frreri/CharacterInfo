...
body_class = {"Death Knight":"death-knight","Demon Hunter":"demon-hunter","Druid":"druid","Hunter":"hunter","Mage":"mage","Monk":"monk","Paladin":"paladin",
...
def char_search(wowrealm,wowcharacter):
    ...
    if all(c.isalpha() for c in wowcharacter) and len(wowcharacter) <13 and len(wowcharacter) >1 and wowrealm in realmlist_l:
        try:
